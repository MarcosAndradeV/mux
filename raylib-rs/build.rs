...
pub fn main() {
    ...
    // Handle UNIX
    if cfg!(unix) {
        println!("cargo::rustc-link-search={out_dir}/raylib-6.0_linux_amd64/lib");
    ...
    generate_bindings("generated.rs", "raylib-6.0_linux_amd64/include/raylib.h");
    generate_bindings("rlgl.rs", "raylib-6.0_linux_amd64/include/rlgl.h");
}
